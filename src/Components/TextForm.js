...
export default function TextForm(props) {
    ...
    return ( <
        ...
        value = { text }
        className = "w-full px-0 text-lg text-gray-900 bg-white border-1 focus:ring-0 dark:text-white"
        id = "myBox"
        cols = "100"
        rows = "8" > < /textarea> <
        /div> <
        ...
        className = "mx-8 px-8 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 rounded" >
